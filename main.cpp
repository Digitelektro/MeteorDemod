...
void writeSymbolToFile(std::ostream& stream, const Wavreader::complex& sample) {
    ...
    outBuffer[0] = static_cast<int8_t>(std::clamp(std::real(sample) * 127.0f, -128.0f, 128.0f));
    outBuffer[1] = static_cast<int8_t>(std::clamp(std::imag(sample) * 127.0f, -128.0f, 128.0f));
